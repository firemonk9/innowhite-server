...
function video() {
	...
	$('body').append('<div class="fade"></div>');
	// $('body').append('<div class="popup-video"><div class="close"><img
	// src="images/pop-close-btn.png" alt="close" /></div><div
	// class="videos"><div class="jp-video jp-video-270p"><div
	// class="jp-type-playlist"><div id="jquery_jplayer_1"
	// class="jp-jplayer"></div><div id="jp_interface_1"
	// class="jp-interface"><div class="jp-video-play"></div><ul
	// class="jp-controls"><li><a href="#" class="jp-play"
	// tabindex="1">play</a></li><li><a href="#" class="jp-pause"
	// tabindex="1">pause</a></li><li><a href="#" class="jp-mute"
	// tabindex="1">mute</a></li><li><a href="#" class="jp-unmute"
	// tabindex="1">unmute</a></li></ul><div class="jp-progress"><div
	// class="jp-seek-bar"><div class="jp-play-bar"></div></div></div><div
	// class="jp-volume-bar"><div class="jp-volume-bar-value"></div></div><div
	// class="jp-duration"></div><div
	// class="jp-current-time"></div></div></div></div></div></div>');
	$('.popup-video').css({
		'left' : wWidth,
		'top' : wHeight
	});
