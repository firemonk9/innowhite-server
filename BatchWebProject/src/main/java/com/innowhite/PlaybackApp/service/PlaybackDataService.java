...
public class PlaybackDataService {
	...
	try {
		...
		while (sessionKeys.hasNext()) {
		    ...
		    log.debug("--------------------------------------------------------------");
		    // paddedSessionAudioDataList contains - session audios
		    // padded
			...
			// pad all the session bucket audios
			// (sessionAudioDataList)
		    ...
		    log.debug("--------------------------------------------------------------");
		    // uniformSessionVideoDataList contains - session videos of
		    // same resolution, format etc
		     ...
		     * the final video playlistelse map each audio with
