...
public class PlaybackVO {
    ...
    public String getWinSilentAudioPath() {
	return winSilentAudioPath;
    }

    public void setWinSilentAudioPath(String winSilentAudioPath) {
	this.winSilentAudioPath = winSilentAudioPath;
    }

    public String getSilentAudioPath() {
