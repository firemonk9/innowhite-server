...
import com.innowhite.mp4converter.dao.CallBackUrlsDao;
import com.innowhite.mp4converter.dao.MP4ConverterDAO;
import com.innowhite.mp4converter.model.CallBackUrlsData;
...
public class MP4ConverterService {
	...
	public CallBackUrlsDao getCallBackUrlsDao() {
		return callBackUrlsDao;
	}
	...
	public void processFLVFile(String unixFLVPath, String fileId) {
		...
		if (ConverterUtil.isWindows() == true) {
			...
			String roomName = mp4ConverterDAO.getRoomID(fileId);

			CallBackUrlsData callBackVO = callBackUrlsDao.getURLData(roomName);
			String url = null;
			if (callBackVO != null) {
	...
	public void convertToMp4(String inputFLVPath, String fileId, String unixFLVPath) {
		...
		try {
			...
			// String ffmpegPath =
			// "C:\\ffmpeg-git-b6ff81d-win32-static\\bin\\ffmpeg.exe";
