...
public class DeleteDocumentServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String imageID = request.getParameter("DOCUMENT_ID");
		Photo obj = new Photo();
		//obj.setImageID(Integer.parseInt(imageID));
		
		log.debug(" completed Delete document++++++++ :"+imageID);
		DocumentManagement.deleteDocuments(Integer.parseInt(imageID));
		
		
		PrintWriter out = response.getWriter();
		
		log.debug(" completed Delete document++++++++ ");
		out.println("");
		out.flush();
		out.close();
	}
