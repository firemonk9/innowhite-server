...
public class FreeswitchHeartbeatMonitor implements Observer {
    ...
    private final FreeSwitchGateway eventListner;

    public FreeswitchHeartbeatMonitor(ManagerConnection connection, FreeSwitchGateway freeSwitchGateway) {
    	this.connection = connection;
        this.eventListner = freeSwitchGateway;
