...
public class Main extends MultiThreadedApplicationAdapter {
	...
	public boolean updateShapeEvents(com.innowhite.red5.vo.ShapeEventsVO v) {
	...
	public boolean updateUserList(com.innowhite.red5.vo.UserListVO uservo) {
...
//						uservo.isGroupLeader()));
	...
	public boolean updateChat(com.innowhite.red5.vo.ChatVO chatvo) {
		try {
	...
	public boolean updateVideo(com.innowhite.red5.vo.VideoDisplayVO videovo) {
