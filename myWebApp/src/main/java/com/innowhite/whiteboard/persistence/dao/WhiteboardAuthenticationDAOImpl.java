...
public class WhiteboardAuthenticationDAOImpl implements IWhiteboardAuthenticationDAO {
    ...
    private static final Logger log = LoggerFactory.getLogger(WhiteboardAuthenticationDAOImpl.class);
	...
	try {
	    ...
	    log.debug(" entered createSubRoomID values  roomId:" + roomId + "  roomType:: " + roomType);
	    ...
	    VideoNameMessageProducer videoSecurityMessageProducer = (VideoNameMessageProducer) factory.getBean("videoSecurityMessageProducer");
    ...
    // public List roomsRecordedList(String status, String orgName, String
    // course,String clientName) {
    // //Map<String, String> roomStatusResultsMap = new HashMap<String,
    // String>();
    // Map<String, String> hmMap = new HashMap<String, String>();
    // hmMap.put("status", status);
