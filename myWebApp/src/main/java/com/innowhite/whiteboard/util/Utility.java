...
public class Utility {
	...
	public static boolean allowedFiles(String fileName) {
		if (fileName != null) {
			...
			if (arr != null && arr.length > 0) {
				...
				if (extension != null && Constants.ALLOWED_INPUT_FILES.indexOf(extension.toLowerCase()) >= 0)
					return true;
			}
		}
		return false;
	...
	public static boolean allowedFilesProceessedonServer(String fileName) {
		if (fileName != null) {
			...
			if (arr != null && arr.length > 0) {
				String extension = arr[arr.length - 1];
				if (extension != null && Constants.ALLOWED_PPTX_INPUT_FILES.indexOf(extension.toLowerCase()) >= 0)
					return true;
			}
		}
		return false;
	...
	public static Date getSqlDateFromStr(String str) {
