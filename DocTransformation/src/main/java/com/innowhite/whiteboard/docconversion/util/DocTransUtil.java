...
/*	
	public static void main(String[] args) {
		FileTransformatioBean ftb = new FileTransformatioBean();
		ftb.setThumbsFolder("/Users/prashanthj/Desktop/Thumbnail");
		String str[] = getThumbnails(ftb);
