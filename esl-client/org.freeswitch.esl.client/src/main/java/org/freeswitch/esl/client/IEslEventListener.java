...
public interface IEslEventListener
{
     ...
     * @param event as an {@link EslEvent}
     */
    void conferenceEventJoin( String confName, int confSize ,EslEvent event);
     ...
     * @param event as an {@link EslEvent}
     */
    void conferenceEventLeave( String confName, int confSize, EslEvent event);
     ...
     * @param event as an {@link EslEvent}
     */
    void conferenceEventUnMute( String confName, int confSize, EslEvent event);
     ...
     * @param event as an {@link EslEvent}
     */
    void conferenceEventAction( String confName, int confSize, String action, EslEvent event);
     ...
     * @param event as an {@link EslEvent}
     */
    void conferenceEventTransfer( String confName, int confSize, EslEvent event);
     ...
     * @param event as an {@link EslEvent}
     */
    void conferenceEventThreadRun( String confName, int confSize, EslEvent event);
     ...
     * @param event as an {@link EslEvent}
     */
    void conferenceEventPlayFile( String confName, int confSize, EslEvent event);
